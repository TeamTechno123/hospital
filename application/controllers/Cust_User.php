...
class Cust_User extends CI_Controller{
  ...
  public function logout(){
    ...
    $this->session->unset_userdata('pharma_customer_id');
...
/**************************      Login      ********************************/
  public function index(){
    $pharma_customer_id = $this->session->userdata('pharma_customer_id');
    $pharma_company_id = $this->session->userdata('pharma_company_id');
    if($pharma_customer_id == '' || $pharma_company_id == ''){
      ...
      if ($this->form_validation->run() == FALSE) {
        ...
        if($login == null){
          ...
          // echo 'null not';
          $this->session->set_userdata('pharma_customer_id', $login[0]['customer_id']);
...
/**************************      Dashboard      ********************************/
  public function dashboard(){
    $pharma_customer_id = $this->session->userdata('pharma_customer_id');
    $pharma_company_id = $this->session->userdata('pharma_company_id');
    if($pharma_customer_id == '' || $pharma_company_id == ''){ header('location:'.base_url().'Cust_User'); }
