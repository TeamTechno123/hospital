...
class User extends CI_Controller{
  ...
  public function logout(){
    ...
    $this->session->unset_userdata('pharma_user_id');
    $this->session->unset_userdata('pharma_company_id');
    $this->session->unset_userdata('pharma_role_id');
...
/**************************      Login      ********************************/
  public function index(){
    ...
    if($pharma_user_id == '' || $pharma_company_id == ''){
      ...
      if ($this->form_validation->run() == FALSE) {
        ...
        if($login == null){
          ...
          // echo 'null not';
          $this->session->set_userdata('pharma_user_id', $login[0]['user_id']);
          $this->session->set_userdata('pharma_company_id', $login[0]['company_id']);
          $this->session->set_userdata('pharma_role_id', $login[0]['role_id']);
...
/**************************      Company Information      ********************************/
  ...
  public function company_list(){
    ...
    $data['company_list'] = $this->Master_Model->get_list($pharma_company_id,'company_id','ASC','company');
    $data['page'] = 'Company';
    $this->load->view('Admin/Include/head', $data);
    $this->load->view('Admin/Include/navbar', $data);
...
/*******************************    Branch Information      ****************************/
  ...
  public function branch(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['company_id'] = $pharma_company_id;
      $save_data['branch_addedby'] = $pharma_user_id;
    ...
    $data['branch_list'] = $this->Master_Model->get_list_by_id3($pharma_company_id,'','','','','','','branch_id','ASC','rest_branch');
    $data['page'] = 'Branch';
    $this->load->view('Admin/Include/head', $data);
    $this->load->view('Admin/Include/navbar', $data);
  ...
  public function edit_branch($branch_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $update_data['branch_addedby'] = $pharma_user_id;
...
/*******************************    User Information      ****************************/
  ...
  public function user_information(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['company_id'] = $pharma_company_id;
      $save_data['user_addedby'] = $pharma_user_id;
    ...
    $data['role_list'] = $this->Master_Model->get_list_by_id3($pharma_company_id,'','','','','','','role_id','ASC','rest_role');
    $data['country_list'] = $this->Master_Model->get_list('','country_name','ASC','country');
    $data['state_list'] = $this->Master_Model->get_list('','state_name','ASC','state');
    $data['district_list'] = $this->Master_Model->get_list('','district_name','ASC','district');
    $data['city_list'] = $this->Master_Model->get_list('','city_name','ASC','city');

    $data['user_list'] = $this->Master_Model->get_list_by_id3($pharma_company_id,'is_admin','0','','','','','user_id','ASC','rest_user');
    $data['page'] = 'User';
    $this->load->view('Admin/Include/head', $data);
    $this->load->view('Admin/Include/navbar', $data);
  ...
  public function edit_user($user_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $update_data['user_addedby'] = $pharma_user_id;
...
/*******************************    Role Information      ****************************/
  ...
  public function role(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['company_id'] = $pharma_company_id;
      $save_data['role_addedby'] = $pharma_user_id;
  ...
  public function edit_role($role_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $update_data['role_addedby'] = $pharma_user_id;
