          ...
          <div class="col-md-12">
            <div class="card <?php if(!isset($update)){ echo 'collapsed-card'; } ?>">
              <div class="card-header">
                <h3 class="card-title"> Priority List</h3>
                  ...
                  <form class="input_form m-0" id="form_action" role="form" action="" method="post" autocomplete="off" enctype="multipart/form-data">
                    <div class="row p-4">
                      <div class="form-group col-md-12 ">
                        ...
                        <input type="text" class="form-control form-control-sm" name="priority" id="priority" value="<?php if(isset($priority_info)){ echo $priority_info['priority']; } ?>" placeholder="Priority" required>
                      </div>
                      ...
                      <div class="row">
                         ...
                         <div class="col-md-6 text-left">
                          <div class="custom-control custom-checkbox">
                            ...
                            <label for="priority_status" class="custom-control-label">Disable This Priority</label>
                          </div>
                        </div>
